...
<br>
  ...
  <br>
    <br>
  33 Koncepte që çdo Programues i JavaScript Duhet Të Dijë
  <br><br>
</h1>
...
Ky dokument është krijuar me qëllimin për të ndihmuar programuesit të përmirësojnë kuptimin e koncepteve në JavaScript. Nuk është e domosdoshme, por një guidë për të rinjtë. Kjo është e bazuar në një artikull të shkruar nga [Stephen Curtis](https://twitter.com/stephenthecurt) dhe ju mund ta lexoni [këtu](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).

**🚀 Konsideruar nga GitHub si një nga [projektet më të mira 'open source' të 2018](https://blog.github.com/2018-12-13-new-open-source-projects/)**

## Komuniteti

Jini të lirshëm të dërgoni PR(pull resuest)-in tuaj nëse keni sugjerime. Nëse doni ta perktheni dokumentin në gjuhën tuaj, ju lutemi ndihuni të lirë ta bëni.

Të gjitha përkthimet janë të listuara më poshtë:
